# Comparing `tmp/radicalpy-0.5.7.tar.gz` & `tmp/radicalpy-0.5rc1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "radicalpy-0.5.7.tar", last modified: Thu Jun  1 09:12:09 2023, max compression
+gzip compressed data, was "radicalpy-0.5rc1.tar", last modified: Fri Dec  2 05:37:43 2022, max compression
```

## Comparing `radicalpy-0.5.7.tar` & `radicalpy-0.5rc1.tar`

### file list

```diff
@@ -1,30 +1,41 @@
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-01 09:12:09.743010 radicalpy-0.5.7/
--rw-r--r--   0 runner    (1001) docker     (122)     1068 2023-06-01 09:12:00.000000 radicalpy-0.5.7/LICENSE
--rw-r--r--   0 runner    (1001) docker     (122)     1413 2023-06-01 09:12:09.743010 radicalpy-0.5.7/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)      772 2023-06-01 09:12:00.000000 radicalpy-0.5.7/README.md
--rw-r--r--   0 runner    (1001) docker     (122)     1343 2023-06-01 09:12:00.000000 radicalpy-0.5.7/pyproject.toml
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-01 09:12:09.739010 radicalpy-0.5.7/radicalpy/
--rw-r--r--   0 runner    (1001) docker     (122)      311 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/__init__.py
--rw-r--r--   0 runner    (1001) docker     (122)     4924 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/classical.py
--rw-r--r--   0 runner    (1001) docker     (122)    16112 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/data.py
--rw-r--r--   0 runner    (1001) docker     (122)    19367 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/estimations.py
--rw-r--r--   0 runner    (1001) docker     (122)     5054 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/kinetics.py
--rw-r--r--   0 runner    (1001) docker     (122)     6252 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/plot.py
--rw-r--r--   0 runner    (1001) docker     (122)     9710 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/relaxation.py
--rw-r--r--   0 runner    (1001) docker     (122)     1007 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/shared.py
--rw-r--r--   0 runner    (1001) docker     (122)    25107 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/simulation.py
--rw-r--r--   0 runner    (1001) docker     (122)    11859 2023-06-01 09:12:00.000000 radicalpy-0.5.7/radicalpy/utils.py
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-01 09:12:09.739010 radicalpy-0.5.7/radicalpy.egg-info/
--rw-r--r--   0 runner    (1001) docker     (122)     1413 2023-06-01 09:12:09.000000 radicalpy-0.5.7/radicalpy.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (122)      545 2023-06-01 09:12:09.000000 radicalpy-0.5.7/radicalpy.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (122)        1 2023-06-01 09:12:09.000000 radicalpy-0.5.7/radicalpy.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (122)       80 2023-06-01 09:12:09.000000 radicalpy-0.5.7/radicalpy.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (122)       10 2023-06-01 09:12:09.000000 radicalpy-0.5.7/radicalpy.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (122)       80 2023-06-01 09:12:00.000000 radicalpy-0.5.7/requirements.txt
--rw-r--r--   0 runner    (1001) docker     (122)       38 2023-06-01 09:12:09.743010 radicalpy-0.5.7/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (122)        0 2023-06-01 09:12:09.743010 radicalpy-0.5.7/tests/
--rw-r--r--   0 runner    (1001) docker     (122)     3157 2023-06-01 09:12:00.000000 radicalpy-0.5.7/tests/test_data.py
--rw-r--r--   0 runner    (1001) docker     (122)     3948 2023-06-01 09:12:00.000000 radicalpy-0.5.7/tests/test_estimations.py
--rw-r--r--   0 runner    (1001) docker     (122)      325 2023-06-01 09:12:00.000000 radicalpy-0.5.7/tests/test_relaxations.py
--rw-r--r--   0 runner    (1001) docker     (122)     1684 2023-06-01 09:12:00.000000 radicalpy-0.5.7/tests/test_shared.py
--rw-r--r--   0 runner    (1001) docker     (122)    19571 2023-06-01 09:12:00.000000 radicalpy-0.5.7/tests/test_simulation.py
...
### Comparing `radicalpy-0.5.7/LICENSE` & `radicalpy-0.5rc1/LICENSE`

 * *Files identical despite different names*

### Comparing `radicalpy-0.5.7/radicalpy/plot.py` & `radicalpy-0.5rc1/src/radicalpy/plot.py`
...
### Comparing `radicalpy-0.5.7/radicalpy/simulation.py` & `radicalpy-0.5rc1/src/radicalpy/simulation.py`
...
### Comparing `radicalpy-0.5.7/tests/test_simulation.py` & `radicalpy-0.5rc1/src/tests/test_simulation.py`
