# Comparing `tmp/tfsim-nightly-0.18.0.dev4.tar.gz` & `tmp/tfsim-nightly-0.18.0.dev5.tar.gz`
...
### Comparing `tfsim-nightly-0.18.0.dev4/LICENSE` & `tfsim-nightly-0.18.0.dev5/LICENSE`
...
### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/algebra.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/algebra.py`
...
### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/base_indexer.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/base_indexer.py`
...
### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/search/faiss_search.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/search/faiss_search.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/search/linear_search.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/search/linear_search.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/search/nmslib_search.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/search/nmslib_search.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/search/search.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/search/search.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/search/utils.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/search/utils.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/stores/__init__.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/stores/__init__.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/stores/cached_store.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/stores/cached_store.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/stores/memory_store.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/stores/memory_store.py`
...
### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/stores/redis_store.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/stores/redis_store.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/stores/store.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/stores/store.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/stores/utils.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/stores/utils.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/training_metrics/__init__.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/training_metrics/__init__.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/training_metrics/distance_metrics.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/training_metrics/distance_metrics.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/training_metrics/utils.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/training_metrics/utils.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/types.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/types.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/utils.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/utils.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/visualization/__init__.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/visualization/__init__.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/visualization/confusion_matrix_viz.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/visualization/confusion_matrix_viz.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/visualization/neighbors_viz.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/visualization/neighbors_viz.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/visualization/projector.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/visualization/projector.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tensorflow_similarity/visualization/vizualize_views.py` & `tfsim-nightly-0.18.0.dev5/tensorflow_similarity/visualization/vizualize_views.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/architectures/test_efficientnet.py` & `tfsim-nightly-0.18.0.dev5/tests/architectures/test_efficientnet.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/architectures/test_resnet18.py` & `tfsim-nightly-0.18.0.dev5/tests/architectures/test_resnet18.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/architectures/test_resnet50.py` & `tfsim-nightly-0.18.0.dev5/tests/architectures/test_resnet50.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/classification_metrics/test_classification_metrics.py` & `tfsim-nightly-0.18.0.dev5/tests/classification_metrics/test_classification_metrics.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/evaluators/test_memory_evaluator.py` & `tfsim-nightly-0.18.0.dev5/tests/evaluators/test_memory_evaluator.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/losses/test_pn_loss.py` & `tfsim-nightly-0.18.0.dev5/tests/losses/test_pn_loss.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/losses/test_softnn_loss.py` & `tfsim-nightly-0.18.0.dev5/tests/losses/test_softnn_loss.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/losses/test_triplet_loss.py` & `tfsim-nightly-0.18.0.dev5/tests/losses/test_triplet_loss.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/losses/test_xbm_loss.py` & `tfsim-nightly-0.18.0.dev5/tests/losses/test_xbm_loss.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/losses/utils.py` & `tfsim-nightly-0.18.0.dev5/tests/losses/utils.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/matchers/test_classification_match.py` & `tfsim-nightly-0.18.0.dev5/tests/matchers/test_classification_match.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/matchers/test_majority_vote.py` & `tfsim-nightly-0.18.0.dev5/tests/matchers/test_majority_vote.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/matchers/test_match_nearest.py` & `tfsim-nightly-0.18.0.dev5/tests/matchers/test_match_nearest.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/models/test_contrastive_model.py` & `tfsim-nightly-0.18.0.dev5/tests/models/test_contrastive_model.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/models/test_similarity_model.py` & `tfsim-nightly-0.18.0.dev5/tests/models/test_similarity_model.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/retrieval_metrics/test_bndcg.py` & `tfsim-nightly-0.18.0.dev5/tests/retrieval_metrics/test_bndcg.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/retrieval_metrics/test_map_at_k.py` & `tfsim-nightly-0.18.0.dev5/tests/retrieval_metrics/test_map_at_k.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/retrieval_metrics/test_precision_at_k.py` & `tfsim-nightly-0.18.0.dev5/tests/retrieval_metrics/test_precision_at_k.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/retrieval_metrics/test_recall_at_k.py` & `tfsim-nightly-0.18.0.dev5/tests/retrieval_metrics/test_recall_at_k.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/retrieval_metrics/test_retrieval_metric.py` & `tfsim-nightly-0.18.0.dev5/tests/retrieval_metrics/test_retrieval_metric.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/samplers/test_file_samplers.py` & `tfsim-nightly-0.18.0.dev5/tests/samplers/test_file_samplers.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/samplers/test_memory_samplers.py` & `tfsim-nightly-0.18.0.dev5/tests/samplers/test_memory_samplers.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/samplers/test_tfdata_sampler.py` & `tfsim-nightly-0.18.0.dev5/tests/samplers/test_tfdata_sampler.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/samplers/test_tfdataset_samplers.py` & `tfsim-nightly-0.18.0.dev5/tests/samplers/test_tfdataset_samplers.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/samplers/test_tfrecord_samplers.py` & `tfsim-nightly-0.18.0.dev5/tests/samplers/test_tfrecord_samplers.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/search/test_faiss_search.py` & `tfsim-nightly-0.18.0.dev5/tests/search/test_faiss_search.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/search/test_linear_search.py` & `tfsim-nightly-0.18.0.dev5/tests/search/test_linear_search.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/search/test_nmslib_search.py` & `tfsim-nightly-0.18.0.dev5/tests/search/test_nmslib_search.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/stores/test_cached_store.py` & `tfsim-nightly-0.18.0.dev5/tests/stores/test_cached_store.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/stores/test_memory_store.py` & `tfsim-nightly-0.18.0.dev5/tests/stores/test_memory_store.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/stores/test_redis_store.py` & `tfsim-nightly-0.18.0.dev5/tests/stores/test_redis_store.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/test_algebra.py` & `tfsim-nightly-0.18.0.dev5/tests/test_algebra.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/test_callbacks.py` & `tfsim-nightly-0.18.0.dev5/tests/test_callbacks.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/test_distances.py` & `tfsim-nightly-0.18.0.dev5/tests/test_distances.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/test_indexer.py` & `tfsim-nightly-0.18.0.dev5/tests/test_indexer.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/test_layers.py` & `tfsim-nightly-0.18.0.dev5/tests/test_layers.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/test_schedules.py` & `tfsim-nightly-0.18.0.dev5/tests/test_schedules.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/test_types.py` & `tfsim-nightly-0.18.0.dev5/tests/test_types.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/test_utils.py` & `tfsim-nightly-0.18.0.dev5/tests/test_utils.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/training_metrics/test_distance_metrics.py` & `tfsim-nightly-0.18.0.dev5/tests/training_metrics/test_distance_metrics.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/visualization/test_confusion_matrix.py` & `tfsim-nightly-0.18.0.dev5/tests/visualization/test_confusion_matrix.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tests/visualization/test_neighbors_viz.py` & `tfsim-nightly-0.18.0.dev5/tests/visualization/test_neighbors_viz.py`

 * *Files identical despite different names*

### Comparing `tfsim-nightly-0.18.0.dev4/tfsim_nightly.egg-info/PKG-INFO` & `tfsim-nightly-0.18.0.dev5/tfsim_nightly.egg-info/PKG-INFO`
...
### Comparing `tfsim-nightly-0.18.0.dev4/tfsim_nightly.egg-info/SOURCES.txt` & `tfsim-nightly-0.18.0.dev5/tfsim_nightly.egg-info/SOURCES.txt`
