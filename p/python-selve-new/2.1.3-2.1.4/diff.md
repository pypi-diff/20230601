# Comparing `tmp/python-selve-new-2.1.3.tar.gz` & `tmp/python-selve-new-2.1.4.tar.gz`
...
### Comparing `python-selve-new-2.1.3/PKG-INFO` & `python-selve-new-2.1.4/PKG-INFO`
