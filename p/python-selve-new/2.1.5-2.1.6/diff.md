# Comparing `tmp/python-selve-new-2.1.5.tar.gz` & `tmp/python-selve-new-2.1.6.tar.gz`
...
### Comparing `python-selve-new-2.1.5/PKG-INFO` & `python-selve-new-2.1.6/PKG-INFO`
