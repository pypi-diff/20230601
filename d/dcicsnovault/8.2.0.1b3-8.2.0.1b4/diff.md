# Comparing `tmp/dcicsnovault-8.2.0.1b3.tar.gz` & `tmp/dcicsnovault-8.2.0.1b4.tar.gz`
...
### Comparing `dcicsnovault-8.2.0.1b3/snovault/__init__.py` & `dcicsnovault-8.2.0.1b4/snovault/__init__.py`
...
### Comparing `dcicsnovault-8.2.0.1b3/snovault/ingestion/ingestion_message_handler_decorator.py` & `dcicsnovault-8.2.0.1b4/snovault/ingestion/ingestion_message_handler_decorator.py`
...
### Comparing `dcicsnovault-8.2.0.1b3/snovault/resources.py` & `dcicsnovault-8.2.0.1b4/snovault/resources.py`
...
### Comparing `dcicsnovault-8.2.0.1b3/snovault/schemas/user.json` & `dcicsnovault-8.2.0.1b4/snovault/schemas/user.json`
...
### Comparing `dcicsnovault-8.2.0.1b3/snovault/tests/test_edw_hash.py` & `dcicsnovault-8.2.0.1b4/snovault/tests/test_edw_hash.py`
...
### Comparing `dcicsnovault-8.2.0.1b3/snovault/tests/test_util.py` & `dcicsnovault-8.2.0.1b4/snovault/tests/test_util.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/tests/test_views.py` & `dcicsnovault-8.2.0.1b4/snovault/tests/test_views.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/tests/testappfixtures.py` & `dcicsnovault-8.2.0.1b4/snovault/tests/testappfixtures.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/tests/testing_upgrader.py` & `dcicsnovault-8.2.0.1b4/snovault/tests/testing_upgrader.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/tests/testing_views.py` & `dcicsnovault-8.2.0.1b4/snovault/tests/testing_views.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/tests/toolfixtures.py` & `dcicsnovault-8.2.0.1b4/snovault/tests/toolfixtures.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/tools.py` & `dcicsnovault-8.2.0.1b4/snovault/tools.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/typedsheets.py` & `dcicsnovault-8.2.0.1b4/snovault/typedsheets.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/typeinfo.py` & `dcicsnovault-8.2.0.1b4/snovault/typeinfo.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/types/access_key.py` & `dcicsnovault-8.2.0.1b4/snovault/types/access_key.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/types/base.py` & `dcicsnovault-8.2.0.1b4/snovault/types/base.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/types/filter_set.py` & `dcicsnovault-8.2.0.1b4/snovault/types/filter_set.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/types/ingestion.py` & `dcicsnovault-8.2.0.1b4/snovault/types/ingestion.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/types/user.py` & `dcicsnovault-8.2.0.1b4/snovault/types/user.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/upgrader.py` & `dcicsnovault-8.2.0.1b4/snovault/upgrader.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/util.py` & `dcicsnovault-8.2.0.1b4/snovault/util.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/validation.py` & `dcicsnovault-8.2.0.1b4/snovault/validation.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/snovault/validators.py` & `dcicsnovault-8.2.0.1b4/snovault/validators.py`

 * *Files identical despite different names*

### Comparing `dcicsnovault-8.2.0.1b3/PKG-INFO` & `dcicsnovault-8.2.0.1b4/PKG-INFO`
