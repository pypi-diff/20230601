# Comparing `tmp/sysml2py-0.1.0.tar.gz` & `tmp/sysml2py-0.1.1.tar.gz`
...
## Comparing `sysml2py-0.1.0.tar` & `sysml2py-0.1.1.tar`
...
### Comparing `sysml2py-0.1.0/LICENSE` & `sysml2py-0.1.1/LICENSE`

 * *Files identical despite different names*

### Comparing `sysml2py-0.1.0/PKG-INFO` & `sysml2py-0.1.1/PKG-INFO`
...
### Comparing `sysml2py-0.1.0/README.md` & `sysml2py-0.1.1/README.md`

 * *Files identical despite different names*

### Comparing `sysml2py-0.1.0/src/sysml2py/textx/xtext_to_textx.py` & `sysml2py-0.1.1/src/sysml2py/textx/xtext_to_textx.py`

 * *Files identical despite different names*

### Comparing `sysml2py-0.1.0/src/sysml2py.egg-info/PKG-INFO` & `sysml2py-0.1.1/src/sysml2py/sysml2py.egg-info/PKG-INFO`
