# Comparing `tmp/oneoneoneexample-0.2.tar.gz` & `tmp/oneoneoneexample-0.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "oneoneoneexample-0.2.tar", last modified: Wed May 31 21:52:38 2023, max compression
+gzip compressed data, was "oneoneoneexample-0.3.tar", last modified: Wed May 31 22:03:12 2023, max compression
```

## Comparing `oneoneoneexample-0.2.tar` & `oneoneoneexample-0.3.tar`

### file list

```diff
@@ -1,14 +1,14 @@
-drwxrwxrwx   0        0        0        0 2023-05-31 21:52:38.004708 oneoneoneexample-0.2/
--rw-rw-rw-   0        0        0       61 2023-05-31 21:52:38.003578 oneoneoneexample-0.2/PKG-INFO
--rw-rw-rw-   0        0        0       45 2023-05-31 18:11:11.000000 oneoneoneexample-0.2/README.md
-drwxrwxrwx   0        0        0        0 2023-05-31 21:52:37.945679 oneoneoneexample-0.2/oneoneoneexample.egg-info/
--rw-rw-rw-   0        0        0       61 2023-05-31 21:52:37.000000 oneoneoneexample-0.2/oneoneoneexample.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      257 2023-05-31 21:52:37.000000 oneoneoneexample-0.2/oneoneoneexample.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2023-05-31 21:52:37.000000 oneoneoneexample-0.2/oneoneoneexample.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       28 2023-05-31 21:52:37.000000 oneoneoneexample-0.2/oneoneoneexample.egg-info/requires.txt
--rw-rw-rw-   0        0        0       14 2023-05-31 21:52:37.000000 oneoneoneexample-0.2/oneoneoneexample.egg-info/top_level.txt
-drwxrwxrwx   0        0        0        0 2023-05-31 21:52:37.961981 oneoneoneexample-0.2/pdf_generator/
--rw-rw-rw-   0        0        0     4873 2023-05-31 21:50:12.000000 oneoneoneexample-0.2/pdf_generator/convert.py
--rw-rw-rw-   0        0        0      239 2023-05-31 21:50:20.000000 oneoneoneexample-0.2/pyproject.toml
--rw-rw-rw-   0        0        0       42 2023-05-31 21:52:38.004708 oneoneoneexample-0.2/setup.cfg
--rw-rw-rw-   0        0        0      237 2023-05-31 21:36:29.000000 oneoneoneexample-0.2/setup.py
...
### Comparing `oneoneoneexample-0.2/pdf_generator/convert.py` & `oneoneoneexample-0.3/pdf_generator/convert.py`
