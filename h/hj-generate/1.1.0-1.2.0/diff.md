# Comparing `tmp/hj-generate-1.1.0.tar.gz` & `tmp/hj-generate-1.2.0.tar.gz`
...
## Comparing `hj-generate-1.1.0.tar` & `hj-generate-1.2.0.tar`
...
### Comparing `hj-generate-1.1.0/generate/generate_code.py` & `hj-generate-1.2.0/generate/generate_code.py`
