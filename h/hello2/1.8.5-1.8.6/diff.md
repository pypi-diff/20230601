# Comparing `tmp/hello2-1.8.5.tar.gz` & `tmp/hello2-1.8.6.tar.gz`
...
## Comparing `hello2-1.8.5.tar` & `hello2-1.8.6.tar`
...
### Comparing `hello2-1.8.5/.gitignore` & `hello2-1.8.6/.gitignore`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/.readthedocs.yaml` & `hello2-1.8.6/.readthedocs.yaml`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/LICENSE` & `hello2-1.8.6/LICENSE`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/docs/Makefile` & `hello2-1.8.6/docs/Makefile`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/docs/make.bat` & `hello2-1.8.6/docs/make.bat`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/docs/source/conf.py` & `hello2-1.8.6/docs/source/conf.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/docs/source/hello.fiftyone.rst` & `hello2-1.8.6/docs/source/hello.fiftyone.rst`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/docs/source/index.rst` & `hello2-1.8.6/docs/source/index.rst`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/README.md` & `hello2-1.8.6/hello/README.md`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/__init__.py` & `hello2-1.8.6/hello/__init__.py`
...
### Comparing `hello2-1.8.5/hello/data/coco2yolo.py` & `hello2-1.8.6/hello/data/coco2yolo.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/__init__.py` & `hello2-1.8.6/hello/fiftyone/__init__.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/annotate.py` & `hello2-1.8.6/hello/fiftyone/annotate.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/brain.py` & `hello2-1.8.6/hello/fiftyone/brain.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/coco.py` & `hello2-1.8.6/hello/fiftyone/coco.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/coco_utils.py` & `hello2-1.8.6/hello/fiftyone/coco_utils.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/connected.py` & `hello2-1.8.6/hello/fiftyone/connected.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/core.py` & `hello2-1.8.6/hello/fiftyone/core.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/dataset.py` & `hello2-1.8.6/hello/fiftyone/dataset.py`
...
### Comparing `hello2-1.8.5/hello/fiftyone/dataset_detections.py` & `hello2-1.8.6/hello/fiftyone/dataset_detections.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/dataset_segmentations.py` & `hello2-1.8.6/hello/fiftyone/dataset_segmentations.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/dataset_yolov5.py` & `hello2-1.8.6/hello/fiftyone/dataset_yolov5.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/dataset_zoo.py` & `hello2-1.8.6/hello/fiftyone/dataset_zoo.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/evaluate.py` & `hello2-1.8.6/hello/fiftyone/evaluate.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/evaluate_detections.py` & `hello2-1.8.6/hello/fiftyone/evaluate_detections.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/evaluate_segmentations.py` & `hello2-1.8.6/hello/fiftyone/evaluate_segmentations.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/examples/examples.py` & `hello2-1.8.6/hello/fiftyone/examples/examples.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/examples/utils.py` & `hello2-1.8.6/hello/fiftyone/examples/utils.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/gen_examples.py` & `hello2-1.8.6/hello/fiftyone/gen_examples.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/mask_ignore.py` & `hello2-1.8.6/hello/fiftyone/mask_ignore.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/miou.py` & `hello2-1.8.6/hello/fiftyone/miou.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/patches.py` & `hello2-1.8.6/hello/fiftyone/patches.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/tarinfo.py` & `hello2-1.8.6/hello/fiftyone/tarinfo.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/unique.py` & `hello2-1.8.6/hello/fiftyone/unique.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/utils.py` & `hello2-1.8.6/hello/fiftyone/utils.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/video.py` & `hello2-1.8.6/hello/fiftyone/video.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fiftyone/view.py` & `hello2-1.8.6/hello/fiftyone/view.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/fvcore/core.py` & `hello2-1.8.6/hello/fvcore/core.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/io/image.py` & `hello2-1.8.6/hello/io/image.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/io/utils.py` & `hello2-1.8.6/hello/io/utils.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmdet/__init__.py` & `hello2-1.8.6/hello/mmdet/__init__.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmdet/flop.py` & `hello2-1.8.6/hello/mmdet/flop.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmdet/infer.py` & `hello2-1.8.6/hello/mmdet/infer.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmdet/log.py` & `hello2-1.8.6/hello/mmdet/log.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmdet/plot.py` & `hello2-1.8.6/hello/mmdet/plot.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmlab/__init__.py` & `hello2-1.8.6/hello/mmlab/__init__.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmlab/mmseg.py` & `hello2-1.8.6/hello/mmlab/mmseg.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmseg/__init__.py` & `hello2-1.8.6/hello/mmseg/__init__.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmseg/infer.py` & `hello2-1.8.6/hello/mmseg/infer.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmseg/log.py` & `hello2-1.8.6/hello/mmseg/log.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/mmseg/lr.py` & `hello2-1.8.6/hello/mmseg/lr.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/nanodet/infer.py` & `hello2-1.8.6/hello/nanodet/infer.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/onnx/examples/test_sigmoid.py` & `hello2-1.8.6/hello/onnx/examples/test_sigmoid.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/onnx/export.py` & `hello2-1.8.6/hello/onnx/export.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/onnx/infer.py` & `hello2-1.8.6/hello/onnx/infer.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/transforms/README.md` & `hello2-1.8.6/hello/transforms/README.md`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/transforms/transforms.py` & `hello2-1.8.6/hello/transforms/transforms.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/utils/colors.py` & `hello2-1.8.6/hello/utils/colors.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/utils/compare.py` & `hello2-1.8.6/hello/utils/compare.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/utils/cuda.py` & `hello2-1.8.6/hello/utils/cuda.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/utils/plots.py` & `hello2-1.8.6/hello/utils/plots.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/utils/points.py` & `hello2-1.8.6/hello/utils/points.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/__init__.py` & `hello2-1.8.6/hello/video/__init__.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/align.py` & `hello2-1.8.6/hello/video/align.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/clip.py` & `hello2-1.8.6/hello/video/clip.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/fisheye.py` & `hello2-1.8.6/hello/video/fisheye.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/info.py` & `hello2-1.8.6/hello/video/info.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/resize.py` & `hello2-1.8.6/hello/video/resize.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/rtsp.py` & `hello2-1.8.6/hello/video/rtsp.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/rtsp_pull.py` & `hello2-1.8.6/hello/video/rtsp_pull.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/split.py` & `hello2-1.8.6/hello/video/split.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/unwarp.py` & `hello2-1.8.6/hello/video/unwarp.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/video/utils.py` & `hello2-1.8.6/hello/video/utils.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/x3m/__init__.py` & `hello2-1.8.6/hello/x3m/__init__.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/x3m/config.py` & `hello2-1.8.6/hello/x3m/config.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/x3m/preprocess.py` & `hello2-1.8.6/hello/x3m/preprocess.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello/x3m/transforms.py` & `hello2-1.8.6/hello/x3m/transforms.py`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello_c/CMakeLists.txt` & `hello2-1.8.6/hello_c/CMakeLists.txt`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello_c/README.md` & `hello2-1.8.6/hello_c/README.md`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/hello_c/main.cpp` & `hello2-1.8.6/hello_c/main.cpp`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/pyproject.toml` & `hello2-1.8.6/pyproject.toml`

 * *Files identical despite different names*

### Comparing `hello2-1.8.5/PKG-INFO` & `hello2-1.8.6/PKG-INFO`
