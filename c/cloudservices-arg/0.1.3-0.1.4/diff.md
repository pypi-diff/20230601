# Comparing `tmp/cloudservices_arg-0.1.3.tar.gz` & `tmp/cloudservices_arg-0.1.4.tar.gz`
...
## Comparing `cloudservices_arg-0.1.3.tar` & `cloudservices_arg-0.1.4.tar`
...
### Comparing `cloudservices_arg-0.1.3/PKG-INFO` & `cloudservices_arg-0.1.4/PKG-INFO`
...
### Comparing `cloudservices_arg-0.1.3/cloudservices_arg.egg-info/PKG-INFO` & `cloudservices_arg-0.1.4/cloudservices_arg.egg-info/PKG-INFO`
...
### Comparing `cloudservices_arg-0.1.3/setup.py` & `cloudservices_arg-0.1.4/setup.py`
