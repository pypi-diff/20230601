# Comparing `tmp/cohere-4.6.0.tar.gz` & `tmp/cohere-4.6.1.tar.gz`
...
### Comparing `cohere-4.6.0/cohere/__init__.py` & `cohere-4.6.1/cohere/__init__.py`
...
### Comparing `cohere-4.6.0/PKG-INFO` & `cohere-4.6.1/PKG-INFO`
