# Comparing `tmp/gs_quant-1.0.2.tar.gz` & `tmp/gs_quant-1.0.3.tar.gz`
...
### Comparing `gs_quant-1.0.2/PKG-INFO` & `gs_quant-1.0.3/PKG-INFO`
...
### Comparing `gs_quant-1.0.2/README.md` & `gs_quant-1.0.3/README.md`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/__init__.py` & `gs_quant-1.0.3/gs_quant/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/common/__init__.py` & `gs_quant-1.0.3/gs_quant/analytics/common/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/common/constants.py` & `gs_quant-1.0.3/gs_quant/analytics/common/constants.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/common/enumerators.py` & `gs_quant-1.0.3/gs_quant/analytics/common/enumerators.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/common/helpers.py` & `gs_quant-1.0.3/gs_quant/analytics/common/helpers.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/core/__init__.py` & `gs_quant-1.0.3/gs_quant/analytics/core/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/core/processor.py` & `gs_quant-1.0.3/gs_quant/analytics/core/processor.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/core/processor_result.py` & `gs_quant-1.0.3/gs_quant/analytics/core/processor_result.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/core/query_helpers.py` & `gs_quant-1.0.3/gs_quant/analytics/core/query_helpers.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/datagrid/__init__.py` & `gs_quant-1.0.3/gs_quant/analytics/datagrid/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/datagrid/data_cell.py` & `gs_quant-1.0.3/gs_quant/analytics/datagrid/data_cell.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/datagrid/data_column.py` & `gs_quant-1.0.3/gs_quant/analytics/datagrid/data_column.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/datagrid/data_row.py` & `gs_quant-1.0.3/gs_quant/analytics/datagrid/data_row.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/datagrid/datagrid.py` & `gs_quant-1.0.3/gs_quant/analytics/datagrid/datagrid.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/datagrid/serializers.py` & `gs_quant-1.0.3/gs_quant/analytics/datagrid/serializers.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/datagrid/utils.py` & `gs_quant-1.0.3/gs_quant/analytics/datagrid/utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/processors/__init__.py` & `gs_quant-1.0.3/gs_quant/analytics/processors/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/processors/analysis_processors.py` & `gs_quant-1.0.3/gs_quant/analytics/processors/analysis_processors.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/processors/econometrics_processors.py` & `gs_quant-1.0.3/gs_quant/analytics/processors/econometrics_processors.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/processors/scale_processors.py` & `gs_quant-1.0.3/gs_quant/analytics/processors/scale_processors.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/processors/special_processors.py` & `gs_quant-1.0.3/gs_quant/analytics/processors/special_processors.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/processors/statistics_processors.py` & `gs_quant-1.0.3/gs_quant/analytics/processors/statistics_processors.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/processors/utility_processors.py` & `gs_quant-1.0.3/gs_quant/analytics/processors/utility_processors.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/workspaces/__init__.py` & `gs_quant-1.0.3/gs_quant/analytics/workspaces/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/workspaces/components.py` & `gs_quant-1.0.3/gs_quant/analytics/workspaces/components.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/analytics/workspaces/workspace.py` & `gs_quant-1.0.3/gs_quant/analytics/workspaces/workspace.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/__init__.py` & `gs_quant-1.0.3/gs_quant/api/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/data.py` & `gs_quant-1.0.3/gs_quant/api/data.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/fred/__init__.py` & `gs_quant-1.0.3/gs_quant/api/fred/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/fred/data.py` & `gs_quant-1.0.3/gs_quant/api/fred/data.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/fred/fred_query.py` & `gs_quant-1.0.3/gs_quant/api/fred/fred_query.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/__init__.py` & `gs_quant-1.0.3/gs_quant/api/gs/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/assets.py` & `gs_quant-1.0.3/gs_quant/api/gs/assets.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/backtests.py` & `gs_quant-1.0.3/gs_quant/api/gs/backtests.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/base_screener.py` & `gs_quant-1.0.3/gs_quant/api/gs/base_screener.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/carbon.py` & `gs_quant-1.0.3/gs_quant/api/gs/carbon.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/content.py` & `gs_quant-1.0.3/gs_quant/api/gs/content.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/countries.py` & `gs_quant-1.0.3/gs_quant/api/gs/countries.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/data.py` & `gs_quant-1.0.3/gs_quant/api/gs/data.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/data_screen.py` & `gs_quant-1.0.3/gs_quant/api/gs/data_screen.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/datagrid.py` & `gs_quant-1.0.3/gs_quant/api/gs/datagrid.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/esg.py` & `gs_quant-1.0.3/gs_quant/api/gs/esg.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/groups.py` & `gs_quant-1.0.3/gs_quant/api/gs/groups.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/hedges.py` & `gs_quant-1.0.3/gs_quant/api/gs/hedges.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/indices.py` & `gs_quant-1.0.3/gs_quant/api/gs/indices.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/monitors.py` & `gs_quant-1.0.3/gs_quant/api/gs/monitors.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/parser.py` & `gs_quant-1.0.3/gs_quant/api/gs/parser.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/plots.py` & `gs_quant-1.0.3/gs_quant/api/gs/plots.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/portfolios.py` & `gs_quant-1.0.3/gs_quant/api/gs/portfolios.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/price.py` & `gs_quant-1.0.3/gs_quant/api/gs/price.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/reports.py` & `gs_quant-1.0.3/gs_quant/api/gs/reports.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/risk.py` & `gs_quant-1.0.3/gs_quant/api/gs/risk.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/risk_models.py` & `gs_quant-1.0.3/gs_quant/api/gs/risk_models.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/screens.py` & `gs_quant-1.0.3/gs_quant/api/gs/screens.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/thematics.py` & `gs_quant-1.0.3/gs_quant/api/gs/thematics.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/users.py` & `gs_quant-1.0.3/gs_quant/api/gs/users.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/gs/workspaces.py` & `gs_quant-1.0.3/gs_quant/api/gs/workspaces.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/risk.py` & `gs_quant-1.0.3/gs_quant/api/risk.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/api/utils.py` & `gs_quant-1.0.3/gs_quant/api/utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/__init__.py` & `gs_quant-1.0.3/gs_quant/backtests/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/action_handler.py` & `gs_quant-1.0.3/gs_quant/backtests/action_handler.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/actions.py` & `gs_quant-1.0.3/gs_quant/backtests/actions.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/backtest_engine.py` & `gs_quant-1.0.3/gs_quant/backtests/backtest_engine.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/backtest_objects.py` & `gs_quant-1.0.3/gs_quant/backtests/backtest_objects.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/backtest_utils.py` & `gs_quant-1.0.3/gs_quant/backtests/backtest_utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/core.py` & `gs_quant-1.0.3/gs_quant/backtests/core.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/data_handler.py` & `gs_quant-1.0.3/gs_quant/backtests/data_handler.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/data_sources.py` & `gs_quant-1.0.3/gs_quant/backtests/data_sources.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/decorator.py` & `gs_quant-1.0.3/gs_quant/backtests/decorator.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/equity_vol_engine.py` & `gs_quant-1.0.3/gs_quant/backtests/equity_vol_engine.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/event.py` & `gs_quant-1.0.3/gs_quant/backtests/event.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/execution_engine.py` & `gs_quant-1.0.3/gs_quant/backtests/execution_engine.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/generic_engine.py` & `gs_quant-1.0.3/gs_quant/backtests/generic_engine.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/order.py` & `gs_quant-1.0.3/gs_quant/backtests/order.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/predefined_asset_engine.py` & `gs_quant-1.0.3/gs_quant/backtests/predefined_asset_engine.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/strategy.py` & `gs_quant-1.0.3/gs_quant/backtests/strategy.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/strategy_systematic.py` & `gs_quant-1.0.3/gs_quant/backtests/strategy_systematic.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/backtests/triggers.py` & `gs_quant-1.0.3/gs_quant/backtests/triggers.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/base.py` & `gs_quant-1.0.3/gs_quant/base.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/common.py` & `gs_quant-1.0.3/gs_quant/common.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/config/__init__.py` & `gs_quant-1.0.3/gs_quant/config/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/config/options.py` & `gs_quant-1.0.3/gs_quant/config/options.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/config.ini` & `gs_quant-1.0.3/gs_quant/config.ini`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/content/reports_and_screens/00_fx/vol_screen_app.py` & `gs_quant-1.0.3/gs_quant/content/reports_and_screens/00_fx/vol_screen_app.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/context_base.py` & `gs_quant-1.0.3/gs_quant/context_base.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/data/__init__.py` & `gs_quant-1.0.3/gs_quant/data/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/data/coordinate.py` & `gs_quant-1.0.3/gs_quant/data/coordinate.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/data/core.py` & `gs_quant-1.0.3/gs_quant/data/core.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/data/dataset.py` & `gs_quant-1.0.3/gs_quant/data/dataset.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/data/fields.py` & `gs_quant-1.0.3/gs_quant/data/fields.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/data/log.py` & `gs_quant-1.0.3/gs_quant/data/log.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/data/query.py` & `gs_quant-1.0.3/gs_quant/data/query.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/data/stream.py` & `gs_quant-1.0.3/gs_quant/data/stream.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/datetime/__init__.py` & `gs_quant-1.0.3/gs_quant/datetime/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/datetime/date.py` & `gs_quant-1.0.3/gs_quant/datetime/date.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/datetime/gscalendar.py` & `gs_quant-1.0.3/gs_quant/datetime/gscalendar.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/datetime/point.py` & `gs_quant-1.0.3/gs_quant/datetime/point.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/datetime/relative_date.py` & `gs_quant-1.0.3/gs_quant/datetime/relative_date.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/datetime/rules.py` & `gs_quant-1.0.3/gs_quant/datetime/rules.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/datetime/time.py` & `gs_quant-1.0.3/gs_quant/datetime/time.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.datetime.date.business_day_count.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.datetime.date.business_day_count.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.datetime.date.business_day_offset.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.datetime.date.business_day_offset.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.datetime.date.date_range.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.datetime.date.date_range.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.datetime.date.is_business_day.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.datetime.date.is_business_day.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.datetime.date.prev_business_date.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.datetime.date.prev_business_date.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.datetime.point.point_sort_order.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.datetime.point.point_sort_order.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.abs_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.abs_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.add.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.add.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.and_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.and_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.ceil.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.ceil.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.divide.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.divide.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.exp.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.exp.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.filter_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.filter_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.floor.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.floor.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.floordiv.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.floordiv.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.if_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.if_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.log.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.log.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.multiply.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.multiply.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.not_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.not_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.or_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.or_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.power.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.power.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.repeat.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.repeat.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.smooth_spikes.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.smooth_spikes.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.sqrt.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.sqrt.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.subtract.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.subtract.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.algebra.weighted_sum.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.algebra.weighted_sum.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.analysis.count.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.analysis.count.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.analysis.diff.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.analysis.diff.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.analysis.first.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.analysis.first.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.analysis.lag.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.analysis.lag.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.analysis.last.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.analysis.last.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.analysis.last_value.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.analysis.last_value.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.analysis.weighted_sum.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.analysis.weighted_sum.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.backtesting.basket.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.backtesting.basket.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.align.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.align.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.date_range.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.date_range.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.day.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.day.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.interpolate.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.interpolate.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.month.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.month.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.prepend.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.prepend.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.quarter.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.quarter.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.union.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.union.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.value.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.value.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.weekday.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.weekday.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.datetime.year.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.datetime.year.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.annualize.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.annualize.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.beta.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.beta.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.change.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.change.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.correlation.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.correlation.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.excess_returns_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.excess_returns_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.index.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.index.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.max_drawdown.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.max_drawdown.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.prices.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.prices.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.returns.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.returns.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.sharpe_ratio.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.sharpe_ratio.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.econometrics.volatility.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.econometrics.volatility.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.cov.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.cov.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.exponential_std.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.exponential_std.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.generate_series.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.generate_series.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.max_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.max_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.mean.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.mean.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.median.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.median.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.min_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.min_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.mode.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.mode.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.percentile.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.percentile.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.percentiles.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.percentiles.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.product.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.product.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.range_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.range_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.std.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.std.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.sum_.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.sum_.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.var.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.var.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.winsorize.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.winsorize.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.statistics.zscores.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.statistics.zscores.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.technicals.bollinger_bands.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.technicals.bollinger_bands.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.technicals.exponential_moving_average.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.technicals.exponential_moving_average.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.technicals.exponential_spread_volatility.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.technicals.exponential_spread_volatility.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.technicals.exponential_volatility.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.technicals.exponential_volatility.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.technicals.moving_average.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.technicals.moving_average.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.technicals.relative_strength_index.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.technicals.relative_strength_index.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/docs/gs_quant.timeseries.technicals.smoothed_moving_average.html` & `gs_quant-1.0.3/gs_quant/docs/gs_quant.timeseries.technicals.smoothed_moving_average.html`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/entities/entitlements.py` & `gs_quant-1.0.3/gs_quant/entities/entitlements.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/entities/entity.py` & `gs_quant-1.0.3/gs_quant/entities/entity.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/entities/tree_entity.py` & `gs_quant-1.0.3/gs_quant/entities/tree_entity.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/errors.py` & `gs_quant-1.0.3/gs_quant/errors.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/instrument/__init__.py` & `gs_quant-1.0.3/gs_quant/instrument/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/instrument/core.py` & `gs_quant-1.0.3/gs_quant/instrument/core.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/instrument/overrides.py` & `gs_quant-1.0.3/gs_quant/instrument/overrides.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/json_convertors.py` & `gs_quant-1.0.3/gs_quant/json_convertors.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/json_encoder.py` & `gs_quant-1.0.3/gs_quant/json_encoder.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/__init__.py` & `gs_quant-1.0.3/gs_quant/markets/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/baskets.py` & `gs_quant-1.0.3/gs_quant/markets/baskets.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/core.py` & `gs_quant-1.0.3/gs_quant/markets/core.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/factor.py` & `gs_quant-1.0.3/gs_quant/markets/factor.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/hedge.py` & `gs_quant-1.0.3/gs_quant/markets/hedge.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/historical.py` & `gs_quant-1.0.3/gs_quant/markets/historical.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/index.py` & `gs_quant-1.0.3/gs_quant/markets/index.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/indices_utils.py` & `gs_quant-1.0.3/gs_quant/markets/indices_utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/markets.py` & `gs_quant-1.0.3/gs_quant/markets/markets.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/optimizer.py` & `gs_quant-1.0.3/gs_quant/markets/optimizer.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/portfolio.py` & `gs_quant-1.0.3/gs_quant/markets/portfolio.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/portfolio_manager.py` & `gs_quant-1.0.3/gs_quant/markets/portfolio_manager.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/portfolio_manager_utils.py` & `gs_quant-1.0.3/gs_quant/markets/portfolio_manager_utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/position_set.py` & `gs_quant-1.0.3/gs_quant/markets/position_set.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/report.py` & `gs_quant-1.0.3/gs_quant/markets/report.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/report_utils.py` & `gs_quant-1.0.3/gs_quant/markets/report_utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/screens.py` & `gs_quant-1.0.3/gs_quant/markets/screens.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/markets/securities.py` & `gs_quant-1.0.3/gs_quant/markets/securities.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/models/__init__.py` & `gs_quant-1.0.3/gs_quant/models/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/models/epidemiology.py` & `gs_quant-1.0.3/gs_quant/models/epidemiology.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/models/risk_model.py` & `gs_quant-1.0.3/gs_quant/models/risk_model.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/models/risk_model_utils.py` & `gs_quant-1.0.3/gs_quant/models/risk_model_utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/priceable.py` & `gs_quant-1.0.3/gs_quant/priceable.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/quote_reports/core.py` & `gs_quant-1.0.3/gs_quant/quote_reports/core.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/risk/__init__.py` & `gs_quant-1.0.3/gs_quant/risk/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/risk/core.py` & `gs_quant-1.0.3/gs_quant/risk/core.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/risk/measures.py` & `gs_quant-1.0.3/gs_quant/risk/measures.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/risk/result_handlers.py` & `gs_quant-1.0.3/gs_quant/risk/result_handlers.py`
...
### Comparing `gs_quant-1.0.2/gs_quant/risk/results.py` & `gs_quant-1.0.3/gs_quant/risk/results.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/risk/scenario_utils.py` & `gs_quant-1.0.3/gs_quant/risk/scenario_utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/risk/scenarios.py` & `gs_quant-1.0.3/gs_quant/risk/scenarios.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/risk/transform.py` & `gs_quant-1.0.3/gs_quant/risk/transform.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/session.py` & `gs_quant-1.0.3/gs_quant/session.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/__init__.py` & `gs_quant-1.0.3/gs_quant/target/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/assets.py` & `gs_quant-1.0.3/gs_quant/target/assets.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/assets_screener.py` & `gs_quant-1.0.3/gs_quant/target/assets_screener.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/backtests.py` & `gs_quant-1.0.3/gs_quant/target/backtests.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/base_screener.py` & `gs_quant-1.0.3/gs_quant/target/base_screener.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/charts.py` & `gs_quant-1.0.3/gs_quant/target/charts.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/common.py` & `gs_quant-1.0.3/gs_quant/target/common.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/content.py` & `gs_quant-1.0.3/gs_quant/target/content.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/coordinates.py` & `gs_quant-1.0.3/gs_quant/target/coordinates.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/countries.py` & `gs_quant-1.0.3/gs_quant/target/countries.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/data.py` & `gs_quant-1.0.3/gs_quant/target/data.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/data_screen.py` & `gs_quant-1.0.3/gs_quant/target/data_screen.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/groups.py` & `gs_quant-1.0.3/gs_quant/target/groups.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/hedge.py` & `gs_quant-1.0.3/gs_quant/target/hedge.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/indices.py` & `gs_quant-1.0.3/gs_quant/target/indices.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/instrument.py` & `gs_quant-1.0.3/gs_quant/target/instrument.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/measures.py` & `gs_quant-1.0.3/gs_quant/target/measures.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/monitor.py` & `gs_quant-1.0.3/gs_quant/target/monitor.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/portfolios.py` & `gs_quant-1.0.3/gs_quant/target/portfolios.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/price.py` & `gs_quant-1.0.3/gs_quant/target/price.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/reports.py` & `gs_quant-1.0.3/gs_quant/target/reports.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/risk.py` & `gs_quant-1.0.3/gs_quant/target/risk.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/risk_models.py` & `gs_quant-1.0.3/gs_quant/target/risk_models.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/screens.py` & `gs_quant-1.0.3/gs_quant/target/screens.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/secmaster.py` & `gs_quant-1.0.3/gs_quant/target/secmaster.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/trades.py` & `gs_quant-1.0.3/gs_quant/target/trades.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/workflow_quote.py` & `gs_quant-1.0.3/gs_quant/target/workflow_quote.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/target/workspaces_markets.py` & `gs_quant-1.0.3/gs_quant/target/workspaces_markets.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/analytics/test_datagrid.py` & `gs_quant-1.0.3/gs_quant/test/analytics/test_datagrid.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/analytics/test_sorting_and_filtering.py` & `gs_quant-1.0.3/gs_quant/test/analytics/test_sorting_and_filtering.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/analytics/test_workspace.py` & `gs_quant-1.0.3/gs_quant/test/analytics/test_workspace.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_assets.py` & `gs_quant-1.0.3/gs_quant/test/api/test_assets.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_backtests.py` & `gs_quant-1.0.3/gs_quant/test/api/test_backtests.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_base_screener.py` & `gs_quant-1.0.3/gs_quant/test/api/test_base_screener.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_cache.py` & `gs_quant-1.0.3/gs_quant/test/api/test_cache.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_carbon.py` & `gs_quant-1.0.3/gs_quant/test/api/test_carbon.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_content.py` & `gs_quant-1.0.3/gs_quant/test/api/test_content.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_data.py` & `gs_quant-1.0.3/gs_quant/test/api/test_data.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_data_screen.py` & `gs_quant-1.0.3/gs_quant/test/api/test_data_screen.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_esg.py` & `gs_quant-1.0.3/gs_quant/test/api/test_esg.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_fred.py` & `gs_quant-1.0.3/gs_quant/test/api/test_fred.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_groups.py` & `gs_quant-1.0.3/gs_quant/test/api/test_groups.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_index.py` & `gs_quant-1.0.3/gs_quant/test/api/test_index.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_instruments.py` & `gs_quant-1.0.3/gs_quant/test/api/test_instruments.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_json.py` & `gs_quant-1.0.3/gs_quant/test/api/test_json.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_monitor.py` & `gs_quant-1.0.3/gs_quant/test/api/test_monitor.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_portfolios.py` & `gs_quant-1.0.3/gs_quant/test/api/test_portfolios.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_reports.py` & `gs_quant-1.0.3/gs_quant/test/api/test_reports.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_risk.py` & `gs_quant-1.0.3/gs_quant/test/api/test_risk.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_risk_models.py` & `gs_quant-1.0.3/gs_quant/test/api/test_risk_models.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_target.py` & `gs_quant-1.0.3/gs_quant/test/api/test_target.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_thread_manager.py` & `gs_quant-1.0.3/gs_quant/test/api/test_thread_manager.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/api/test_users.py` & `gs_quant-1.0.3/gs_quant/test/api/test_users.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/backtest/test_backtest_eq_vol_engine.py` & `gs_quant-1.0.3/gs_quant/test/backtest/test_backtest_eq_vol_engine.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/backtest/test_backtest_flow_vol.py` & `gs_quant-1.0.3/gs_quant/test/backtest/test_backtest_flow_vol.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/backtest/test_backtest_predefined.py` & `gs_quant-1.0.3/gs_quant/test/backtest/test_backtest_predefined.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/backtest/test_generic_engine.py` & `gs_quant-1.0.3/gs_quant/test/backtest/test_generic_engine.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/backtest/test_triggers.py` & `gs_quant-1.0.3/gs_quant/test/backtest/test_triggers.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/data/test_data_coordinate.py` & `gs_quant-1.0.3/gs_quant/test/data/test_data_coordinate.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/data/test_dataset.py` & `gs_quant-1.0.3/gs_quant/test/data/test_dataset.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/datetime_/test_date.py` & `gs_quant-1.0.3/gs_quant/test/datetime_/test_date.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/datetime_/test_gscalendar.py` & `gs_quant-1.0.3/gs_quant/test/datetime_/test_gscalendar.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/datetime_/test_point.py` & `gs_quant-1.0.3/gs_quant/test/datetime_/test_point.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/datetime_/test_relative_date.py` & `gs_quant-1.0.3/gs_quant/test/datetime_/test_relative_date.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/datetime_/test_time.py` & `gs_quant-1.0.3/gs_quant/test/datetime_/test_time.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/fixtures/content.py` & `gs_quant-1.0.3/gs_quant/test/fixtures/content.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/markets/test_baskets.py` & `gs_quant-1.0.3/gs_quant/test/markets/test_baskets.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/markets/test_hedger.py` & `gs_quant-1.0.3/gs_quant/test/markets/test_hedger.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/markets/test_instrument.py` & `gs_quant-1.0.3/gs_quant/test/markets/test_instrument.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/markets/test_portfolio.py` & `gs_quant-1.0.3/gs_quant/test/markets/test_portfolio.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/markets/test_portfolio_manager.py` & `gs_quant-1.0.3/gs_quant/test/markets/test_portfolio_manager.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/markets/test_pricing_context.py` & `gs_quant-1.0.3/gs_quant/test/markets/test_pricing_context.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/markets/test_report.py` & `gs_quant-1.0.3/gs_quant/test/markets/test_report.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/markets/test_securities.py` & `gs_quant-1.0.3/gs_quant/test/markets/test_securities.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/models/__init__.py` & `gs_quant-1.0.3/gs_quant/test/models/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/models/test_epidemiology.py` & `gs_quant-1.0.3/gs_quant/test/models/test_epidemiology.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/models/test_risk_model.py` & `gs_quant-1.0.3/gs_quant/test/models/test_risk_model.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/test_base.py` & `gs_quant-1.0.3/gs_quant/test/test_base.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/multi_measure/test_commod.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/multi_measure/test_commod.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/multi_measure/test_measure_registry.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/multi_measure/test_measure_registry.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_algebra.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_algebra.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_analysis.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_analysis.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_backtesting.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_backtesting.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_datetime.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_datetime.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_econometrics.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_econometrics.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_helper.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_helper.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_measures.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_measures.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_measures_countries.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_measures_countries.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_measures_fx_vol.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_measures_fx_vol.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_measures_inflation.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_measures_inflation.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_measures_portfolios.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_measures_portfolios.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_measures_rates.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_measures_rates.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_measures_reports.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_measures_reports.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_measures_risk_models.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_measures_risk_models.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_measures_xccy.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_measures_xccy.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_rolling.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_rolling.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_statistics.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_statistics.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_tca.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_tca.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_technicals.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_technicals.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/test_timeseries.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/test_timeseries.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/timeseries/utils.py` & `gs_quant-1.0.3/gs_quant/test/timeseries/utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/utils/datagrid_test_utils.py` & `gs_quant-1.0.3/gs_quant/test/utils/datagrid_test_utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/utils/mock_calc.py` & `gs_quant-1.0.3/gs_quant/test/utils/mock_calc.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/utils/mock_data.py` & `gs_quant-1.0.3/gs_quant/test/utils/mock_data.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/utils/mock_request.py` & `gs_quant-1.0.3/gs_quant/test/utils/mock_request.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/test/utils/test_utils.py` & `gs_quant-1.0.3/gs_quant/test/utils/test_utils.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/__init__.py` & `gs_quant-1.0.3/gs_quant/timeseries/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/algebra.py` & `gs_quant-1.0.3/gs_quant/timeseries/algebra.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/analysis.py` & `gs_quant-1.0.3/gs_quant/timeseries/analysis.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/backtesting.py` & `gs_quant-1.0.3/gs_quant/timeseries/backtesting.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/datetime.py` & `gs_quant-1.0.3/gs_quant/timeseries/datetime.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/econometrics.py` & `gs_quant-1.0.3/gs_quant/timeseries/econometrics.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/helper.py` & `gs_quant-1.0.3/gs_quant/timeseries/helper.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measure_registry.py` & `gs_quant-1.0.3/gs_quant/timeseries/measure_registry.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures_countries.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures_countries.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures_fx_vol.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures_fx_vol.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures_helper.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures_helper.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures_inflation.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures_inflation.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures_portfolios.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures_portfolios.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures_rates.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures_rates.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures_reports.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures_reports.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures_risk_models.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures_risk_models.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/measures_xccy.py` & `gs_quant-1.0.3/gs_quant/timeseries/measures_xccy.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/statistics.py` & `gs_quant-1.0.3/gs_quant/timeseries/statistics.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/tca.py` & `gs_quant-1.0.3/gs_quant/timeseries/tca.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/timeseries/technicals.py` & `gs_quant-1.0.3/gs_quant/timeseries/technicals.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/tracing/__init__.py` & `gs_quant-1.0.3/gs_quant/tracing/__init__.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant/tracing/tracing.py` & `gs_quant-1.0.3/gs_quant/tracing/tracing.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant.egg-info/PKG-INFO` & `gs_quant-1.0.3/gs_quant.egg-info/PKG-INFO`
...
### Comparing `gs_quant-1.0.2/gs_quant.egg-info/SOURCES.txt` & `gs_quant-1.0.3/gs_quant.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/gs_quant.egg-info/requires.txt` & `gs_quant-1.0.3/gs_quant.egg-info/requires.txt`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/setup.py` & `gs_quant-1.0.3/setup.py`

 * *Files identical despite different names*

### Comparing `gs_quant-1.0.2/versioneer.py` & `gs_quant-1.0.3/versioneer.py`
