# Comparing `tmp/noba-1.1.2.tar.gz` & `tmp/noba-1.1.6.tar.gz`
...
### Comparing `noba-1.1.2/noba/helper/datatable.py` & `noba-1.1.6/noba/helper/datatable.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/helper/label.py` & `noba-1.1.6/noba/helper/label.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/helper/marker.py` & `noba-1.1.6/noba/helper/marker.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/helper/params.py` & `noba-1.1.6/noba/helper/params.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/indicators/__init__.py` & `noba-1.1.6/noba/indicators/__init__.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/indicators/extraline.py` & `noba-1.1.6/noba/indicators/extraline.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/ioc/__init__.py` & `noba-1.1.6/noba/ioc/__init__.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/ioc/container.py` & `noba-1.1.6/noba/ioc/container.py`
...
### Comparing `noba-1.1.2/noba/live/client.py` & `noba-1.1.6/noba/live/client.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/live/datahandler.py` & `noba-1.1.6/noba/live/datahandler.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/optbrowser.py` & `noba-1.1.6/noba/optbrowser.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/plugin/annualreturn.py` & `noba-1.1.6/noba/plugin/annualreturn.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/plugin/bbroker.py` & `noba-1.1.6/noba/plugin/bbroker.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/plugin/cerebro.py` & `noba-1.1.6/noba/plugin/cerebro.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/plugin/logger.py` & `noba-1.1.6/noba/plugin/logger.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/plugin/model.py` & `noba-1.1.6/noba/plugin/model.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/plugin/order.py` & `noba-1.1.6/noba/plugin/order.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/plugin/plot.py` & `noba-1.1.6/noba/plugin/plot.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/plugin/writer.py` & `noba-1.1.6/noba/plugin/writer.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/schemes/blackly.py` & `noba-1.1.6/noba/schemes/blackly.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/schemes/scheme.py` & `noba-1.1.6/noba/schemes/scheme.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/schemes/tradimo.py` & `noba-1.1.6/noba/schemes/tradimo.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/service/__init__.py` & `noba-1.1.6/noba/service/__init__.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/service/abs.py` & `noba-1.1.6/noba/service/abs.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/service/backtest.py` & `noba-1.1.6/noba/service/backtest.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/service/config.py` & `noba-1.1.6/noba/service/config.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/service/core.py` & `noba-1.1.6/noba/service/core.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/service/dber.py` & `noba-1.1.6/noba/service/dber.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/service/event.py` & `noba-1.1.6/noba/service/event.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/service/pipeline.py` & `noba-1.1.6/noba/service/pipeline.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/snippet.py` & `noba-1.1.6/noba/snippet.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/tab.py` & `noba-1.1.6/noba/tab.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/tabs/analyzer.py` & `noba-1.1.6/noba/tabs/analyzer.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/tabs/config.py` & `noba-1.1.6/noba/tabs/config.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/tabs/liveconfig.py` & `noba-1.1.6/noba/tabs/liveconfig.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/tabs/log.py` & `noba-1.1.6/noba/tabs/log.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/tabs/metadata.py` & `noba-1.1.6/noba/tabs/metadata.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/tabs/source.py` & `noba-1.1.6/noba/tabs/source.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/templates/basic.css.j2` & `noba-1.1.6/noba/templates/basic.css.j2`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/templates/basic.html.j2` & `noba-1.1.6/noba/templates/basic.html.j2`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/templates/bootstrap/__init__.py` & `noba-1.1.6/noba/templates/bootstrap/__init__.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/templates/bootstrap/boot_providers.py` & `noba-1.1.6/noba/templates/bootstrap/boot_providers.py`
...
### Comparing `noba-1.1.2/noba/templates/bootstrap/register_alias.py` & `noba-1.1.6/noba/templates/bootstrap/register_alias.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/templates/bootstrap/register_providers.py` & `noba-1.1.6/noba/templates/bootstrap/register_providers.py`
...
### Comparing `noba-1.1.2/noba/templates/config/project_config.json` & `noba-1.1.6/noba/templates/config/project_config.json`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/templates/js/handler.js` & `noba-1.1.6/noba/templates/js/handler.js`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/templates/js/hover_tooltips.js` & `noba-1.1.6/noba/templates/js/hover_tooltips.js`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/templates/js/tick_formatter.js` & `noba-1.1.6/noba/templates/js/tick_formatter.js`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/utils.py` & `noba-1.1.6/noba/utils.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/web.py` & `noba-1.1.6/noba/web.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba/webapp.py` & `noba-1.1.6/noba/webapp.py`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/noba.egg-info/PKG-INFO` & `noba-1.1.6/noba.egg-info/PKG-INFO`
...
### Comparing `noba-1.1.2/noba.egg-info/SOURCES.txt` & `noba-1.1.6/noba.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `noba-1.1.2/setup.py` & `noba-1.1.6/setup.py`
